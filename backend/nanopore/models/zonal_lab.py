...
class ZonalLaboratory(models.Model):
    ...
    pretomanid = models.ForeignKey(PhenotypicDSTResults, on_delete=models.SET_NULL, null=True, blank=True, related_name="zonal_laboratory_pretomanid_phenotypic_dst")
