...
from nanopore.forms.laboratory.edcs_tblis.edcs_tblis_lab_form import EdcsTblisZonalForm  # adjust path
...
class EdcsTblisFormView(LoginRequiredMixin, View):
    template_name = "nanopore/laboratory/edcs_tblis/edcs_tblis_laboratory_form.html"
    success_url = reverse_lazy("nanopore:edcs-tblis-laboratory-list")

    def get_object(self):
        pk = self.kwargs.get("pk")
        if pk:
            return get_object_or_404(EdcsTblisZonal, pk=pk)
        return None
