...
class DiagnosisForm(forms.ModelForm):
    class Meta:
        ...
        labels = {
            ...
            "diagnosis_made_other": "5. If Other Specify ?",
            ...
            "tb_clinically_other": "7. Other Specify ?",
            "clinician_received_date": "6(a). Date result received by clinician:",
            "tb_treatment": "8(a). Was TB treatment started?",
            "tb_treatment_date": "8(b). What was treatment start date ?",
            ...
            "tb_regimen_other": "9(b). Regimens specify",
            ...
            "tb_other_specify": "12(a). If Other Mention ( or If Bacterial pneumonia, specify causative species if known)",
