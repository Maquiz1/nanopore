...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "reports.context_processors.form_missing.forms_context.forms_report_total",
                "reports.context_processors.form_queries.screening_context.screening_report_total",
                "reports.context_processors.form_queries.enrollment_context.enrollment_report_total",
                "reports.context_processors.form_queries.clinic_laboratory_context.clinic_report_total",
                "reports.context_processors.form_queries.diagnosis_context.diagnosis_report_total",
                "reports.context_processors.form_queries.zonal_laboratory_context.zonal_report_total",
