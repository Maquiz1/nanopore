...
class Command(BaseCommand):
    help = "Create daily Zonal Laboratory Data Quality snapshot"
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("Zonal Laboratory DQ snapshot created"))
