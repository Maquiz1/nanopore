...
class ModelsListView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        for info in models_info:
            ...
            # Dynamic export URLs per model
            export_labels_url = reverse("reports:download-model-csv", kwargs={
                "app_label": info["app_label"],
                "model_name": info["model_name"]
            }) + "?fk=names"

            export_values_url = reverse("reports:download-model-csv", kwargs={
                "app_label": info["app_label"],
                "model_name": info["model_name"]
            }) + "?fk=values"
            ...
            models_list.append({
                ...
                "count": count,
                "export_labels_url": export_labels_url,
                "export_values_url": export_values_url,
            })
