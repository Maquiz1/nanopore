# reports/views/queries/laboratory/clinic/data_clinic_quality_view.py
...
class ClinicDataQualityView(View):

    template_name = (
        "reports/data_quality/laboratory/clinic/data_clinic_quality_report.html"
    )
